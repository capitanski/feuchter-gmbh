...
const Circles = new Proxy({"src":"/custom-folder/Swirl.BUIxi6cc.webp","width":1000,"height":1000,"format":"webp"}, {
...
const unterhemdSeite = new Proxy({"src":"/custom-folder/Unterhemd BWBM Seite.Bvr2muWa.webp","width":1080,"height":1080,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const unterhemdFront = new Proxy({"src":"/custom-folder/Unterhemd BWBM vorne.AC3qWuqN.webp","width":1080,"height":1080,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const monteurkombiFront = new Proxy({"src":"/custom-folder/Monteurkombi Front.DX68Kodp.webp","width":1000,"height":1000,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const monteurkombiSeite = new Proxy({"src":"/custom-folder/Monteurkombi Seite.D6P9Dhxp.webp","width":1000,"height":1000,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const ksJacke = new Proxy({"src":"/custom-folder/Kaelteschutzjacke Seite.B-lo5IZU.webp","width":1000,"height":1000,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const ksHose = new Proxy({"src":"/custom-folder/Kaelteschutzhose Seite.BUHN5Dr5.webp","width":1000,"height":1000,"format":"webp"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
