...
import 'kleur/colors';
import { p as projects, C as Circles, $ as $$ProjectTag } from './projects_dap78bP4.mjs';
import { A as Arrow } from './Arrow_sand_CKat7LSH.mjs';
import { b as buttonTranslations, t as translations } from './Layout_BIZBW9qJ.mjs';
/* empty css                         */
...
const $$Projects = createComponent(($$result, $$props, $$slots) => {
  ...
  const heading = {
    de: "Laufende & Abgeschlossene Projekte",
