...
const PolizeihemdWappen = new Proxy({"src":"/custom-folder/polizeihemd_bayern_wappen.oOIcuZsu.png","width":500,"height":500,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/home/felix/Desktop/feuchtergmbh_website/feuchter-gmbh/src/assets/polizeihemd_bayern_wappen.png";
							}
...
const projects = [
  {
    ...
    images: [PolizeihemdWappen.src, PolizeihemdWappen.src, PolizeihemdWappen.src],
    amount: 51000,
    status: {
      de: "Laufend",
      en: "Running",
